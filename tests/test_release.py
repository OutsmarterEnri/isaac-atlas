...
class ReleaseTests(unittest.TestCase):
    ...
    def test_schema_two_validation(self):
        ...
        clean=live.validate(value);self.assertEqual(clean['events'][0]['character'],'Tainted Eden');self.assertEqual(clean['pickups'][0]['subtype'],166);self.assertEqual(clean['secretCandidates'],[])
